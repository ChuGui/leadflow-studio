...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-transparent to-gray-900/50 py-16 px-6 border-t border-gray-800">
      <div className="max-w-7xl mx-auto">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* Brand Section */}
          <div className="md:col-span-2">
            <h3 className="font-[family-name:var(--font-space-grotesk)] text-2xl font-bold gradient-text mb-4">
              LeadFlow Studio
            </h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href="mailto:contact@leadflowstudio.com" className="text-gray-300 hover:text-white transition-colors">
                  contact@leadflowstudio.com
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="tel:0780971175" className="text-gray-300 hover:text-white transition-colors">
                  07 80 97 11 75
                </a>
              </div>
            </div>
